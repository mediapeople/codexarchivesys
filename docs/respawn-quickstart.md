...
Ignore deprecated iCloud root. Re-orient from docs/respawn-system-files-v3.md and docs/respawn-quickstart.md, then continue implementation from current git state without reverting unrelated changes.
```
