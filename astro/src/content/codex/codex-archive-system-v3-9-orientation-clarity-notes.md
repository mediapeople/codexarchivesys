...
connections:
  - ref: codex-archive-system-v3-8-specimen-surface-notes
    ...
    display: feature
  - ref: on-object-oriented-archives
    role: archive doctrine
  - ref: systems-survive-tuesdays
    role: personal continuity

media: []

version: "3.9.0"
scope: "site naming clarity, homepage archive thesis, orientation human framing, and empathic public copy"
systemArea: "reader orientation and public-facing communication"
changeType: minor
dependencies:
  - codex-archive-system-v3-8-specimen-surface-notes
...
v3.9 extends [Codex Archive System v3.8 Specimen Surface Notes](/objects/codex-archive-system-v3-8-specimen-surface-notes).
...
1. Header identity now favors clarity over domain shorthand
...
2. The feed hero now opens with one readable invitation
...
3. Orientation now carries the deeper human context
...
4. Public copy now aims for empathy as well as precision
