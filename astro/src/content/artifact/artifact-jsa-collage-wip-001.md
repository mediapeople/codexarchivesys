...
media:
  - kind: image
    ...
    role: hero
    alt: "Primary full-frame view of the JSA collage in unfinished state."
  - kind: image
    src: /media/artifacts/jsa-collage-wip-001-2.jpg
    role: gallery
    alt: "Secondary view of layered comic panel fragments and torn joins."
  - kind: image
    src: /media/artifacts/jsa-collage-wip-001-3.jpg
    role: detail
    alt: "Detail view of compressed panel collisions and speech fragments."
  - kind: image
    src: /media/artifacts/jsa-collage-wip-001-4.jpg
    role: detail
    alt: "Detail view of layered comic geometry and adhesive seams."
  - kind: image
    src: /media/artifacts/jsa-collage-wip-001-5.jpg
    role: process
    alt: "Process-stage view emphasizing extraction marks and edge behavior."

artifactType: collage
materials: "Glossy comic paper, adhesive"
year: 2026
source: "Justice Society of America issue fragments (DC Comics)"
location: "Garage studio"
condition: "stable, unfinished"
---
